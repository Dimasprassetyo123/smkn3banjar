                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="../../../storages/kepalaSekolah/<?= $item->headmasters_photo ?>"
                                                    alt="gambar" width="100" height="100" style="object-fit: cover;">
                                            </td>
                                            <td class="text-uppercase"><?= $item->headmasters_name ?></td>
                                            <td>
                                                <?= substr($item->headmasters_description, 0, 100) . (strlen($item->headmasters_description) > 100 ? '...' : '') ?>
                                            </td>
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <?php if ($_SESSION['role'] === 'admin'): ?>
                                                        <a href="../../action/headmaster/destroy.php?id=<?= $item->id ?>"
