                ...
                <div class="col-12 mt-5">
                    <div class="card card-purple">
                        <div class="card-header">
                            <h3 class="card-title">Detail Informasi Kepala Sekolah</h3>
                        </div>
                        ...
                        <div class="card-body detail-container">
                            <div class="detail-row">
                                ...
                                <div class="detail-value">
                                    <img src="../../../storages/kepalaSekolah/<?= $headmaster->headmasters_photo ?>" 
                                         alt="Gambar <?= htmlspecialchars($headmaster->headmasters_name) ?>" 
                                         class="detail-image"
                                         onerror="this.src='https://via.placeholder.com/280x350?text=Gambar+Tidak+Tersedia'">
                                </div>
                            </div>
                            ...
                            <div class="detail-row">
                                ...
                                <div class="detail-value">
                                    <strong><?= htmlspecialchars($headmaster->headmasters_name) ?></strong>
                                </div>
                            </div>
                            ...
                            <div class="detail-row">
                                ...
                                <div class="detail-value detail-description">
                                    <?= nl2br(htmlspecialchars($headmaster->headmasters_description)) ?>
                                </div>
                            </div>

                            <div class="btn-action">
                                <a href="./edit.php?id=<?= $headmaster->id ?>" class="btn btn-info">
