                ...
                <div class="col-12 mt-5">
                    <div class="card card-purple">
                        <div class="card-header">
                            <h3 class="card-title">Form Edit Data Prestasi</h3>
                        </div>

                        <div class="card-body">
                            <form action="../../action/pencapaian/update.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="image-container">
                                            <img src="../../../storages/pencapaian/<?= $achievement->image ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="5"
                                        placeholder="Deskripsi lengkap tentang pencapaian..." required><?= htmlspecialchars($achievement->description) ?></textarea>
                                </div>
