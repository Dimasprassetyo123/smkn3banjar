...
$visimisi = "SELECT * FROM visi_misions";
$result = mysqli_query($connect, $visimisi) or die(mysqli_error($connect));
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-uppercase"><?= $item->text ?></td>
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <?php if ($_SESSION['role'] === 'admin'): ?>
                                                        <a href="../../action/visimisi/destroy.php?id=<?= $item->id ?>"
