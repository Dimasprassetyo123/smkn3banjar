...
$galleries = "SELECT * FROM galleries ORDER BY id DESC";
$result = mysqli_query($connect, $galleries) or die(mysqli_error($connect));
                    ...
                    <div class="card card-purple mt-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="galleriesTable" class="table table-bordered table-striped table-hover mb-0">
                                    <thead>
                                        <tr>
                                            <th width="50">No</th>
                                            ...
                                            <?php $no = 1; while ($item = $result->fetch_object()): ?>
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <img src="../../../storages/gallerie/<?= $item->image ?>"
                                                             alt="gambar" width="100" height="100"
                                                             style="object-fit: cover; border-radius: 5px;">
                                                    </td>
                                                    <td class="text-uppercase align-middle"><?= $item->description ?></td>
                                                    <td class="align-middle">
                                                        <div class="d-flex">
                                                            ...
                                                            <?php if ($_SESSION['role'] === 'superadmin'): ?>
                                                                <a href="../../action/gallerie/destroy.php?id=<?= $item->id ?>"
