                ...
                <div class="col-12 mt-5">
                    <div class="card card-purple">
                        <div class="card-header">
                            <h3 class="card-title">Form Edit Data Galeri</h3>
                        </div>

                        <div class="card-body">
                            <form action="../../action/gallerie/update.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?= $gallerie->id ?>">
                                <input type="hidden" name="current_image" value="<?= $gallerie->image ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="5"
                                        placeholder="Deskripsi lengkap tentang pencapaian..." required><?= htmlspecialchars($gallerie->description) ?></textarea>
                                </div>
